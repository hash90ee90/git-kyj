...
array1 [1] =55;
console.log(array2); //스프레드 연산자와 달리 원본 배열 수정
...
let number1 = [1, 2, 3];
let number2 = [4, 5, 6];
let mergeArray = [...number1, ...number2];
let mergeReverse = [...number2, ...number1] ;

console.log(mergeArray);
console.log(mergeReverse);
...
let fruits = ['사과', '망고', '바나나'] ;
let result = fruits.join();
let resultWithSpase = fruits.join(' ');
let resultWithDash = fruits.join('-');
console.log(result);
console.log(resultWithSpase);
