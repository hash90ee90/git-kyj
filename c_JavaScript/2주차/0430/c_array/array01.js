...
sports.length = 4;
console.log(sports); //[ '축구', 'baseball', <2 empty items> ] - undefined 값이 2개
...
fruits.splice(1, 2, "Apple", "Banana");
console.log(fruits);
...
let mixNumbers = [52, 50, 60, 70, 46, 0]
console.log(mixNumbers.sort());
...
console.log(mixNumbers.reverse());