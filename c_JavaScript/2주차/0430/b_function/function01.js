...
// let pi = 3.14; - Error 식별자가 이미 사용되고 있음
...

{
  ...
  // 섀도잉
  // : 블록이 다른 경우(중첩될) 내부 변수가 외부 변수를 가리는 현상
  {
    let pi = 3.141592653;
...
// 함수 블록을 사용한 스코프 생성
function sample(){
  let pi = 3.1415962533333;
  console.log(`파이6의 값은 ${pi}입니다.`);
}
...
(function() {
  let commonVar = `ITFE 내부 변수`; //전역 변수에 작성된 것 처럼 동작
  console.log(commonVar);
