...
function exampleFunction(param1, param2, ...args){ //아규먼트 복수어
  // let param1 ;
  // let param2 ;
  // let args = [];
...
print(1, 2, 3, 4, 5);
// 1, 2의 값은 num1, num2 에 차례대로 할당, 나머지 값은 numbers 배열에 할당
...
let minResult = findMin(58, 35, 21, 37, 24);
...
function combinedExample(firstParam, ...restOfParams) {
  // firstParam: 첫번째 인자
  // restOfParams: 나머지 인자들을 배열 형태로 반음
