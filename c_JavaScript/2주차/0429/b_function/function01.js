...
// : 모듈성은 복잡한 작업을 작은 단위로 나누어 관리할 수 있다는 특성을 의미
...
console.log(calculateDistance(3, 1, 0, 0));
console.log(calculateDistance(3, 4, 0, 0));



//? 3. 이벤트 처리
// : 웹 페이지에서 발생하는 다양한 이벤트(버튼 클릭, 폼 제출 등)를 처리하는데 사용
...
// greeting(); - Error 호이스팅 인식 X
// : let과 const 변수의 호이스팅 동작 방식과 동일

const greeting = function () {
  console.log('안녕하세요, 함수 표현식 입니다.');
}
...
function kyj() {
  ...
  let jop = ` KBS`;
  console.log(jop);
  return youjin + jop; //문자열 연산자 (+)
}

console.log(kyj());
// console.log(jop); - Error (지역 변수의 값에 접근 하지 못함)
