...
let mutiLine1 = '안녕하세요'; //일반 따옴표의 경우 여러 줄 문자 작성이 불가

let mutiLine2 = `벡틱을 사용한 템플릿 문자열은
여러 줄로 작성이 가능합니다
세 번째 줄 작성 중입니다.`;

console.log(mutiLine2);

//? 논리형 (Boolean)
// : 참(true) | 거짓(false) 값만을 가지는 자료형

let bool = 100 < 10; //false
console.log(bool);
...
// : 변수가 '비어있음'을 의도적으로 표현하고자 할 때 사용
// (변수에 할당된) 데이터의 값이 유효하지 않은 상태

console.log(null);
console.log(typeof null); //object - 비워져 있지만 해당 데이터는 객체라는 구조를 따름
